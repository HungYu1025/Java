...
public class AddEmployeeManageUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AddEmployeeManageUI frame = new AddEmployeeManageUI();
	...
	public AddEmployeeManageUI() {
		...
		employeename.setBounds(225, 150, 150, 25);
		...
		enter.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e1) {
				...
				else 
				{
					...
					Employee ee = new Employee(Username,Password,Employeename,Gender,City,Area,Road,Email,Phone);
					new EmployeeDaoImpl().add(ee);
